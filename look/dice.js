...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-01a1fc2f');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-01a1fc2f');}
...
function clearFlash(){dieView.classList.remove('rl-win-01a1fc2f');dieView.classList.remove('rl-lose-01a1fc2f');if(frameEl){frameEl.classList.remove('rl-win-01a1fc2f');frameEl.classList.remove('rl-lose-01a1fc2f');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-01a1fc2f');if(frameEl){frameEl.classList.add('rl-win-01a1fc2f');}}else{dieView.classList.add('rl-lose-01a1fc2f');if(frameEl){frameEl.classList.add('rl-lose-01a1fc2f');}}
...
var brandEl=document.querySelector('.rl-brand-01a1fc2f');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
